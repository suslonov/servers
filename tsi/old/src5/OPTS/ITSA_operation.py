...
def __calc_score(input_dict: dict):
    ...
    format_dict["Marital_status"] = parms.marital_status[input_dict["Marital_status"]]
    format_dict["Children"] = parms.children[input_dict["Children"]]
    format_dict["Education"] = parms.education[input_dict["Education"]]
    format_dict["Citizenship"] = parms.countries[input_dict["Citizenship"]]
    ...
    for key in scores:
        contribution = format_dict[key] * scores[key]
        print("Adding contribution of " + str(contribution) + " for " + str(key))
        TS += contribution
