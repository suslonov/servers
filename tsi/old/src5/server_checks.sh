...
a1='r-synergy.com:8022'
b2='r-synergy.com:8020'
echo $a1, $b2

############# Get a good user ITSA	##
curl -X PUT -H "Content-Type:application/json" $a1/onboard_assign_TS -d '{"Date_of_birth": "1950-1-1", "balance":10000000, "Bank_account": true, "Bank_reference": true, "Children":"Have_grandchildren", "Citizenship":"USA", "Country": "SGP", "Credit_card_holder": true, "Education": "PhD_Doctorate", "Employment_status": "Employed", "Marital_status":"Permament_relationship", "Has_license": true, "Identification": "Passport", "Income": "$32000+", "Income_source_declared": true, "Insurance": true, "Investor": true, "Last_fraud_time": "1900", "No_digital_footprint": false, "No_frauds": true, "Phone": true, "Proof_of_residence": true, "Stake": 1000000, "ZIP_code": true, "user_ID":"ABCDE"}'
...
curl -X PUT -H "Content-Type:application/json" $b2/insert_update_user -d '{"TS":34.8344226044226,"balance":10000000,"time_joined":"2018-06-27T14:40:22.675042","time_last_turn_adj":"2018-06-27T14:40:22.675042","time_prev_txn":"2018-06-27T14:40:22.675042","user_ID":"ABCDE"}'
echo '{"user_ID":"ABCDE"}'
########## Checking user (TSUA) details ##
curl -X PUT -H "Content-Type:application/json" $b2/check_user_params -d '{"user_ID":"ABCDE"}'
...
############# Adding an bad (terrrible) user (worst values chosen by default)##
 curl -X PUT -H "Content-Type:application/json" $a1/onboard_assign_TS -d '{"user_ID":"xyzab"}'
...
########## Adding to working (TSUA) DB 	##
curl -X PUT -H "Content-Type:application/json" $b2/insert_update_user -d '{"TS":0.0,"balance":1,"time_joined":"2018-06-27T14:49:10.102102","time_last_turn_adj":"2018-06-27T14:49:10.102102","time_prev_txn":"2018-06-27T14:49:10.102102","user_ID":"xyzab"}'
echo '{"user_ID":"xyzab"}'
########## Checking user (TSUA) details ##
curl -X PUT -H "Content-Type:application/json" $b2/check_user_params -d '{"user_ID":"xyzab"}'
...
### Adding to working (TSUA) DB 	##
curl -X PUT -H "Content-Type:application/json" $b2/insert_update_user -d '{"TS":27.485841523341524,"balance":10000,"time_joined":"2018-06-27T15:04:58.746600","time_last_turn_adj":"2018-06-27T15:04:58.746600","time_prev_txn":"2018-06-27T15:04:58.746600","user_ID":"peter"}'
echo '{"user_ID":"peter"}'
### Checking user (TSUA) details	##
curl -X PUT -H "Content-Type:application/json" $b2/check_user_params -d '{"user_ID":"peter"}'
...
#################################################
curl -X PUT -H "Content-Type:application/json" $b2/new_txn_update_all_DBs -d '{"sender_ID":"peter", "receiver_ID":"xyzab","amount":250,"wrong_doing":"none"}'
echo '{"TS":27.91098310810811,"type":"senders new TS"}'

curl -X PUT -H "Content-Type:application/json" $b2/new_txn_update_all_DBs -d '{"sender_ID":"peter", "receiver_ID":"xyzab","amount":250,"wrong_doing":"none"}'
echo '{"TS":28.33187327702703,"type":"senders new TS"}'

curl -X PUT -H "Content-Type:application/json" $b2/new_txn_update_all_DBs -d '{"sender_ID":"ABCDE", "receiver_ID":"xyzab","amount":250,"wrong_doing":"none"}'
echo '{"TS":35.186078378378376,"type":"senders new TS"}'

curl -X PUT -H "Content-Type:application/json" $b2/new_txn_update_all_DBs -d '{"sender_ID":"ABCDE", "receiver_ID":"peter","amount":250,"wrong_doing":"none"}'
echo '{"TS":35.534217594594594,"type":"senders new TS"}'

curl -X PUT -H "Content-Type:application/json" $b2/new_txn_update_all_DBs -d '{"sender_ID":"peter", "receiver_ID":"ABCDE","amount":2500,"wrong_doing":"major"}'
echo '{"TS":14.165936638513514,"type":"senders new TS"}'

curl -X PUT -H "Content-Type:application/json" $b2/new_txn_update_all_DBs -d '{"sender_ID":"ABCDE", "receiver_ID":"peter","amount":2500,"wrong_doing":"minor"}'
echo '{"TS":33.75750671486486,"type":"senders new TS"}'
#################################################
##	Checking transaction history
#################################################
curl -X PUT -H "Content-Type:application/json" $b2/check_spending_history -d '{"user_ID":"ABCDE"}'
...
curl -X PUT -H "Content-Type:application/json" $b2/check_receiving_history -d '{"user_ID":"ABCDE"}'
...
curl -X PUT -H "Content-Type:application/json" $b2/check_spending_history -d '{"user_ID":"xyzab"}'
echo '{"amount":[],"receiver_ID":[],"sender_trust":[],"transaction_time":[],"wrong_doing":[]}'

curl -X PUT -H "Content-Type:application/json" $b2/check_receiving_history -d '{"user_ID":"xyzab"}'
...
curl -X PUT -H "Content-Type:application/json" $b2/check_spending_history -d '{"user_ID":"peter"}'
...
curl -X PUT -H "Content-Type:application/json" $b2/check_receiving_history -d '{"user_ID":"peter"}'
