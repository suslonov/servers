...
#curl -X PUT -H "Content-Type:application/json" $a1/onboard_assign_TS -d '{"Date_of_birth": "1950", "balance":10000000, "Bank_account": true, "Bank_reference": true, "Children":"Have_grandchildren", "Citizenship":"USA", "Country": "SGP", "Credit_card_holder": true, "Education": "PhD_Doctorate", "Employment_status": "Employed", "Marital_status":"Permament_relationship", "Has_license": true, "Identification": "Passport", "Income": "$32000+", "Income_source_declared": true, "Insurance": true, "Investor": true, "Last_fraud_time": "1900", "No_digital_footprint": false, "No_frauds": true, "Phone": true, "Proof_of_residence": true, "Stake": 1000000, "ZIP_code": true, "user_ID":"ABCDE"}'
