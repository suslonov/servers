...
def insert_new_user_in_db(user_info: dict):
    try:
        if "user_ID" not in user_info:
            ...
            raise Exception("Incorrect user info submitted - at minimum a " + parms.uid_length.__repr__() + " character uid,  is needed, but " +
        ...
        message = \
            "User " + str(user_info["user_ID"]) + " successfully added to db."
        return (message)
